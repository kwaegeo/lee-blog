...
<div class="container">
	<form action="/auth/loginProc" method="post">
		...
		<a href="https://kauth.kakao.com/oauth/authorize?client_id=0a11c0576595d61402a54f0ddc3d8753&redirect_uri=http://localhost:8000/auth/kakao/callback&response_type=code 
